...
//I2C端口定义
#define I2C_SCL1    GPIOout(GPIOE, 11)	//SCL--PB10
#define I2C_SDA1    GPIOout(GPIOE, 12)	//SDA--PB11
#define READ_SDA1   GPIOin( GPIOE, 12)	//输入SDA



//设置SDA:PD11输入输出
#define SDA1_IN()  {GPIOE->CRH&=0XFFFF0FFF;GPIOE->CRH|=8<<12;}		//参考stm32寄存器配置
#define SDA1_OUT() {GPIOE->CRH&=0XFFFF0FFF;GPIOE->CRH|=3<<12;}
